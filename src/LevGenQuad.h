#pragma once
#include "../engine/shader/shaders/levgen/VertLevGen.h"


namespace LevGenQuad {
    ...
    inline VertLevGen * vbufferForIndex(Renderable * r, size_t quadIndex) {
        return (VertLevGen *)(r->buffer + buffersSize(quadIndex));
    }
